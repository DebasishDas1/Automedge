...
function PricingTableHeader({ ...props }: React.ComponentProps<"thead">) {
  return <thead data-slot="table-header" className="bg-background/50 backdrop-blur-sm" {...props} />;
}
...
function PricingTableBody({
  ...
  return (
    <tbody
      ...
      className={cn("[&_tr]:divide-x [&_tr]:border-b border-border/50", className)}
      {...props}
    />
  );
}
...
function PricingTableRow({ ...props }: React.ComponentProps<"tr">) {
  return <tr data-slot="table-row" className="hover:bg-muted/30 transition-colors" {...props} />;
}
...
function PricingTableCell({
  ...
  return (
    <td
      ...
      className={cn("p-4 align-middle whitespace-nowrap text-center min-w-[140px]", className)}
      {...props}
    >
      {children === true ? (
        ...
        <div className="flex justify-center">
          <MinusIcon
            aria-hidden="true"
            className="text-muted-foreground opacity-30 size-5"
          />
        </div>
      ) : (
        children
...
function PricingTableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "p-4 text-left align-middle font-black text-foreground/80 whitespace-nowrap sticky left-0 z-20 bg-background/95 backdrop-blur-md border-r border-border/50 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)] min-w-[200px]",
        className,
      )}
      {...props}
    />
